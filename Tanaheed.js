$(`<center>
    <div id="sultan13">
        ...
        <a id="ahmed21" style="border-radius: 0px 0px 15px 0px!important; width: 85px; padding: 1px; height: 22px;" class="btn minix btn-primary" target="_blank" href="#">اتصل بنا</a>
    </div>
</center>`).insertBefore('.nav.nav-tabs');
$(`<div>
    <marquee direction="right" width="100%" class="bg" onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="0" scrollamount="6" style="text-align: center;height: 23px;color: #ffffff;font-family: jazeera,FontAwesome;margin-right: -1px;margin-top: 5px;border-radius: 30px;width: 100%;padding: 1px;">
        <span style="color: #ffffff;">أهــــلا وســـهلاً .. بكم في شـات نـــاهيد </span>
        <span style="color: #f8b4d9;">- سعداء بتشريفك فأهلاً بك عطْراً فوَّاحاً ينثرُ شذاه في كلِّ الأَرجاء نتمنى لك وقتاً ممتعاً ..  قريباً </span>
        <span style="color: #f9e1b2;">- أفضل غرفة قريباََ </span>
        <span style="color: #d6d5f0;">- أفضل سوبر قريباََ </span>
        <span style="color: #d3e5a4;">- أفضل إدارة قريباََ </span>
        <span style="color: #f6b8b2;">- مايــكات ، مسابـــقات ، فعــــــــاليات ، جَـــــوائز </span>
        <span style="color: #e8e1c3;">- نتمني لكم قضــــــاء أمتع الأوقات | الاداره ||مــــلامــــح</span>
    </marquee>
</div>`).insertBefore('div#tlogins #sultan13');


const audioContainer = `
  <div id="audio-container">
    <button class="play-btn label-primary">🎵 تشغيل التسجيل 🎵</button>
    <audio id="custom-audio" style="display: none;" loop>
      <source src="https://files.catbox.moe/o51hcj.mp4" type="audio/mpeg">
                ...
                if (!welcomeShown && $('#d2').length) {
                    ...
                    $('body').append(`
                        <div id="welcome-message">
                           ...
                           ، حللتَ أهلاً ووطئتَ سهلاً، نتمنى لك أجمل الأوقات، ومشاركة طيبة مليئة بالاحترام والفائدة. وجودك يُسعدنا، وتواصلك يُشرفنا.||𝒎𝒂𝒍𝒂𝒎𝒊𝒉|| ❤️ <br>
                            ✨   ✨
                        </div>
                    `);                                   
                    launchBlueRain();
...
$("body").append(`
    <style>
        ...
        #d2bc {
            background-color: #000 !important;
            background-image: url(https://up6.cc/2026/04/177524844255851.jpg);
            background-size: 100%;
        }
...
#chats{  
background-image: url(https://up6.cc/2026/04/177524946143931.jpg);  
background-size: 100%;
}
